...
#write_parquet(wego_df, 'Data/WeGO_APC_and_Old_Weather.parquet')
...
write_csv(wego_stations, 'Data/wego_stations.csv')
...
plot(wego_stations, pch = 1, col = 'green')

shapefile(wego_stations, filename = 'wego_stations.shp', overwrite = TRUE)
